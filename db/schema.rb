...
ActiveRecord::Schema[7.1].define(version: 2025_11_14_173609) do
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id"], name: "idx_contact_account_id"
    t.index ["account_id"], name: "index_contacts_on_account_id"
    t.index ["account_id"], name: "index_resolved_contact_account_id", where: "(((email)::text <> ''::text) OR ((phone_number)::text <> ''::text) OR ((identifier)::text <> ''::text))"
    t.index ["blocked"], name: "idx_contact_blocked"
    t.index ["blocked"], name: "index_contacts_on_blocked"
    t.index ["company_id"], name: "idx_contact_company_id"
    t.index ["company_id"], name: "index_contacts_on_company_id"
    t.index ["email", "account_id"], name: "uniq_email_per_account_contact", unique: true
    t.index ["email"], name: "idx_contact_email"
    t.index ["identifier", "account_id"], name: "uniq_identifier_per_account_contact", unique: true
    t.index ["identifier"], name: "idx_contact_identifier"
    t.index ["name", "email", "phone_number", "identifier"], name: "index_contacts_on_name_email_phone_number_identifier", opclass: :gin_trgm_ops, using: :gin
    t.index ["phone_number", "account_id"], name: "index_contacts_on_phone_number_and_account_id"
    t.index ["phone_number"], name: "idx_contact_phone"
  end
  ...
  create_table "crm_tags", id: :bigint, default: nil, force: :cascade do |t|
    ...
    t.string "name", limit: 255, null: false
    t.index ["account_id"], name: "idx_tag_account_id"
    t.index ["deleted_at"], name: "idx_tag_deleted_at"
  ...
  create_table "lead_assignments", id: :bigint, default: nil, force: :cascade do |t|
    t.bigint "account_id", null: false
    t.timestamptz "assigned_at", precision: 6, null: false
    t.bigint "assignee_id", null: false
    t.bigint "lead_id", null: false
    t.string "method", limit: 50
    t.index ["account_id"], name: "idx_lead_assignment_account_id"
    t.index ["assigned_at"], name: "idx_lead_assignment_assigned_at"
    t.index ["assignee_id"], name: "idx_lead_assignment_assignee_id"
    t.index ["lead_id"], name: "idx_lead_assignment_lead_id"
  end

  create_table "lead_conversations", primary_key: ["conversation_id", "lead_id"], force: :cascade do |t|
    t.bigint "conversation_id", null: false
    t.bigint "lead_id", null: false
    t.timestamptz "linked_at", precision: 6, null: false
    t.index ["conversation_id"], name: "idx_lead_conversation_conversation_id"
    t.index ["lead_id"], name: "idx_lead_conversation_lead_id"
    t.index ["linked_at"], name: "idx_lead_conversation_linked_at"
  end

  create_table "lead_filters", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    ...
    t.text "share_scope", null: false
    t.index ["account_id"], name: "idx_lead_filter_account_id"
    t.index ["deleted_at"], name: "idx_lead_filter_deleted_at"
    t.index ["name"], name: "idx_lead_filter_name"
    t.index ["owner_user_id"], name: "idx_lead_filter_owner_user_id"
  end

  create_table "lead_group_sets", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    ...
    t.bigint "owner_user_id"
    t.text "share_scope", null: false
    t.index ["account_id"], name: "idx_lead_group_set_account_id"
    t.index ["deleted_at"], name: "idx_lead_group_set_deleted_at"
    t.index ["name"], name: "idx_lead_group_set_name"
    t.index ["owner_user_id"], name: "idx_lead_group_set_owner_user_id"
  end

  create_table "lead_groups_cache", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.bigint "account_id", null: false
    t.jsonb "definition", null: false
    t.string "definition_hash", limit: 64, null: false
    t.jsonb "result", null: false
    t.timestamptz "valid_until", precision: 6, null: false
    t.index ["account_id"], name: "idx_lead_groups_cache_account_id"
    t.index ["valid_until"], name: "idx_lead_groups_cache_valid_until"
    t.unique_constraint ["definition_hash"], name: "idx_lead_groups_cache_definition_hash"
  end

  create_table "lead_notes", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.bigint "author_id", null: false
    t.text "body", null: false
    t.bigint "lead_id", null: false
    t.index ["author_id"], name: "idx_lead_note_author_id"
    t.index ["created_at"], name: "idx_lead_note_created_at"
    t.index ["lead_id"], name: "idx_lead_note_lead_id"
  end

  create_table "lead_stage_history", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.bigint "account_id", null: false
    t.timestamptz "at", precision: 6, null: false
    t.bigint "by_user_id"
    t.bigint "from_stage_id"
    t.bigint "lead_id", null: false
    t.text "note"
    t.bigint "to_stage_id", null: false
    t.index ["account_id"], name: "idx_lead_stage_history_account_id"
    t.index ["at"], name: "idx_lead_stage_history_at"
    t.index ["by_user_id"], name: "idx_lead_stage_history_by_user_id"
    t.index ["from_stage_id"], name: "idx_lead_stage_history_from_stage"
    t.index ["lead_id"], name: "idx_lead_stage_history_lead_id"
    t.index ["to_stage_id"], name: "idx_lead_stage_history_to_stage"
  end

  create_table "lead_stages", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    t.boolean "lost_flag", null: false
    t.text "name", null: false
    t.bigint "pipeline_id", null: false
    t.integer "position", null: false
    t.boolean "won_flag", null: false
    t.index ["account_id"], name: "idx_stage_account_id"
    t.index ["deleted_at"], name: "idx_stage_deleted_at"
    t.index ["pipeline_id", "position"], name: "idx_stage_position"
    t.index ["pipeline_id"], name: "idx_stage_pipeline_id"
  end

  create_table "lead_tags", primary_key: ["lead_id", "tag_id"], force: :cascade do |t|
    t.bigint "lead_id", null: false
    t.bigint "tag_id", null: false
    t.timestamptz "created_at", precision: 6, null: false
    t.index ["lead_id"], name: "idx_lead_tag_lead_id"
    t.index ["tag_id"], name: "idx_lead_tag_tag_id"
  end

  create_table "lead_views", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    ...
    t.text "share_scope", null: false
    t.index ["account_id", "is_default"], name: "idx_lead_view_is_default"
    t.index ["account_id", "pinned"], name: "idx_lead_view_pinned"
    t.index ["account_id"], name: "idx_lead_view_account_id"
    t.index ["deleted_at"], name: "idx_lead_view_deleted_at"
    t.index ["name"], name: "idx_lead_view_name"
    t.index ["owner_user_id"], name: "idx_lead_view_owner_user_id"
  end

  create_table "leads", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    ...
    t.bigint "contact_id"
    t.timestamptz "first_response_at", precision: 6
    t.timestamptz "last_touch_at", precision: 6
    t.text "name", null: false
    t.bigint "owner_id"
    t.bigint "pipeline_id", null: false
    ...
    t.text "priority"
    t.integer "score"
    t.timestamptz "sla_due_at", precision: 6
    t.bigint "stage_id", null: false
    t.bigint "channel_id"
    t.bigint "source_id"
    t.text "status"
    t.bigint "user_id"
    t.index ["account_id"], name: "idx_lead_account_id"
    t.index ["contact_id"], name: "idx_lead_contact_id"
    t.index ["created_at"], name: "idx_lead_created_at"
    t.index ["deleted_at"], name: "idx_lead_deleted_at"
    t.index ["owner_id"], name: "idx_lead_owner_id"
    t.index ["pipeline_id"], name: "idx_lead_pipeline_id"
    t.index ["primary_email"], name: "idx_lead_email"
    t.index ["primary_phone"], name: "idx_lead_phone"
    t.index ["priority"], name: "idx_lead_priority"
    t.index ["stage_id"], name: "idx_lead_stage_id"
    t.index ["status"], name: "idx_lead_status"
  end
  ...
  create_table "pipelines", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.bigint "account_id", null: false
    ...
    t.text "name", null: false
    t.integer "position", null: false
    t.index ["account_id", "is_default"], name: "idx_pipeline_is_default"
    t.index ["account_id"], name: "idx_pipeline_account_id"
    t.index ["deleted_at"], name: "idx_pipeline_deleted_at"
  end
  ...
  create_table "sources", id: :bigint, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", precision: 6, null: false
    t.timestamptz "updated_at", precision: 6, null: false
    t.timestamptz "deleted_at", precision: 6
    t.string "description", limit: 255, null: false
    t.string "name", limit: 255, null: false
    t.index ["deleted_at"], name: "idx_source_deleted_at"
    t.index ["name"], name: "idx_source_name"
  end
